package com.example.ss13_authentication.service;

import com.example.ss13_authentication.entity.AppUser;
import com.example.ss13_authentication.entity.UserRole;
import com.example.ss13_authentication.repository.IAppUserRepository;
import com.example.ss13_authentication.repository.IUserRoleRepository;
...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String userName) throws UsernameNotFoundException {
        ...
        List<UserRole> userRoleList = this.userRoleRepository.findUserRolesByAppUser(appUser);
